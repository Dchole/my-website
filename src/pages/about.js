  ...
  return (
    <>
      ...
      <div className="container max-w-screen-md m-auto pt-24">
        <h1 className="text-6xl text-gray-900 font-headline font-bold">
          About Me
        </h1>
        <p className="mt-5 text-gray-600 font-body tracking-body">
        ...
        <p className="mt-4 text-gray-600 font-body tracking-body">
